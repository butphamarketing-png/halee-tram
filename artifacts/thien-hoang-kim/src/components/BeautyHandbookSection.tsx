...
function ArticleCard({
  ...
  return (
    <article className="group flex h-full min-w-0 cursor-pointer flex-col">
      <div
        className={cn(
...
export function BeautyHandbookSection({ articles }: BeautyHandbookSectionProps) {
  ...
  return (
    <section className="border-y border-border bg-white py-10 md:py-24">
      <div className="container mx-auto px-4 md:px-8">
        <h2 className="mb-6 text-center font-serif text-2xl font-semibold md:mb-10 md:hidden">
          CẨM NANG LÀM ĐẸP
        </h2>

        <div className="mb-8 hidden md:mb-10 md:flex md:items-center md:justify-between md:gap-6">
          <h2 className="font-serif text-5xl font-semibold">CẨM NANG LÀM ĐẸP</h2>
          {viewAllButton}
        </div>
        ...
        {/* Desktop: carousel (3 cột, không cuộn) */}
